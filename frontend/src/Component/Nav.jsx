...
function Nav() {
    ...
    return (
        ...
        <div className='fixed top-0 bg-[white] z-[20]'>
          ...
          <img src={logo} alt="StayFinder Logo" className="h-20 object-contain" />
          <span className="text-2xl font-bold">
            ...
            <span className="text-blue-600">Finder</span>
                ...
                <div className='w-[35%] relative hidden md:block '>
                    ...
                    <button className='absolute p-[10px] rounded-[50px] bg-[blue] right-[3%] top-[5px]'><FiSearch className='w-[20px] h-[20px] text-[white]' /></button>
                </div>
