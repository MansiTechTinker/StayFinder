  ...
  return (
    <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
        ...
        <form action="" className='max-w-[900px] w-[90%] h-[550px] flex items-center justify-start flex-col md:items-start gap-[10px] overflow-auto mt-[50px]' onSubmit={(e)=>{e.preventDefault()
            ...
            <div className='w-[200px] h-[50px] text-[20px] bg-[#4368ee] text-[white] flex items-center justify-center rounded-[30px] absolute top-[5%] right-[10px] shadow-lg'>
                SetUp Your Home
            </div>
            ...
            <button className='px-[50px] py-[10px] bg-[blue] text-[white] text-[18px] md:px-[100px] rounded-lg '>Next</button>
